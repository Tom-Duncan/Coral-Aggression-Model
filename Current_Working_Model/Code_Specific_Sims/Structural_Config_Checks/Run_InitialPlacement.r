...
#
#  RUN:  Rscript Current_Working_Model/Structural_Config_Checks/Run_InitialPlacement.r
#  Output: Current_Working_Model/Results/InitialPlacement_<timestamp>_results.{rds,csv}
# =============================================================================
