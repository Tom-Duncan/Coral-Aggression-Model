# =============================================================================
#  REAL INTERACTION MATRICES - empirically derived overgrowth-probability
#  matrices for the model, from published coral aggression data.
#
...
interaction_xlsx_dir <- "C:/Users/dell/Documents/Research Project 2/Modelling/Current_Working_Model/Interaction_Matrices"
